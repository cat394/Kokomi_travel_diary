<script>
	...
	import Photos from '$lib/components/pages/about/Photos.svelte';
...
<Hero>
	<Image slot="media" name="root:about_hero" />
	Who is Kokomi...?
</Hero>
<Divider />
<Contents>
	<Container title="自己しょーかい">
		<Sentence>
			<svelte:component this={data.myIntro} />
		</Sentence>
	</Container>
	<Container title="フォト">
		<Photos />
